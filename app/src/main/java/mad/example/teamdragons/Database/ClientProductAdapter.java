...
import mad.example.teamdragons.ProductModel;
import mad.example.teamdragons.R;

public class ClientProductAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private ArrayList<ProductModel> productList;

    public ClientProductAdapter(Context context, int layout, ArrayList<ProductModel> productList) {
